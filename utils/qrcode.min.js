  ...
  h.prototype = {
    ...
    make: function() {
      if (this.typeNumber < 1) {
        var t = 1;
        for (t = 1; t < 40; t++) {
          for (var e = P.getRSBlocks(t, this.errorCorrectLevel), r = new b, o = 0, n = 0; n < e.length; n++) o += e[n].dataCount;
        ...
        for (6 == a && a--;;) {
          for (var u = 0; u < 2; u++)
            if (null == this.modules[o][a - u]) {
              var s = !1;
              i < t.length && (s = 1 == (t[i] >>> n & 1)), A.getMask(e, o, a - u) && (s = !s), this.modules[o][a - u] = s, -1 == --n && (i++, n = 7)
    ...
    for (var o = P.getRSBlocks(t, e), n = new b, i = 0; i < r.length; i++) {
      var a = r[i];
      n.put(a.mode, 4), n.put(a.getLength(), A.getLengthInBits(a.mode, t)), a.write(n)
    }
    var u = 0;
    ...
    for (var r = 0, o = 0, n = 0, i = new Array(e.length), a = new Array(e.length), u = 0; u < e.length; u++) {
      ...
      var f = A.getErrorCorrectPolynomial(h),
        g = new M(i[u], f.getLength() - 1).mod(f);
    ...
    var m = new Array(d),
      p = 0;
    for (l = 0; l < o; l++)
      for (u = 0; u < e.length; u++) l < i[u].length && (m[p++] = i[u][l]);
    for (l = 0; l < n; l++)
      for (u = 0; u < e.length; u++) l < a[u].length && (m[p++] = a[u][l]);
    return m
  };
  for (var f = {
      MODE_NUMBER: 1,
      ...
      MODE_8BIT_BYTE: 4,
      MODE_KANJI: 8
    }, g = 1, c = 0, d = 3, m = 2, p = 0, v = 1, C = 2, B = 3, L = 4, w = 5, y = 6, E = 7, A = {
      ...
      getErrorCorrectPolynomial: function(t) {
        for (var e = new M([1], 0), r = 0; r < t; r++) e = e.multiply(new M([1, _.gexp(r)], 0));
        return e
      },
    ...
    }, D = 0; D < 8; D++) _.EXP_TABLE[D] = 1 << D;
  for (D = 8; D < 256; D++) _.EXP_TABLE[D] = _.EXP_TABLE[D - 4] ^ _.EXP_TABLE[D - 5] ^ _.EXP_TABLE[D - 6] ^ _.EXP_TABLE[D - 8];
  for (D = 0; D < 255; D++) _.LOG_TABLE[_.EXP_TABLE[D]] = D;
  ...
  return M.prototype = {
      ...
      multiply: function(t) {
        for (var e = new Array(this.getLength() + t.getLength() - 1), r = 0; r < this.getLength(); r++)
          for (var o = 0; o < t.getLength(); o++) e[r + o] ^= _.gexp(_.glog(this.get(r)) + _.glog(t.get(o)));
        return new M(e, 0)
      },
      mod: function(t) {
      ...
      for (var o = r.length / 3, n = new Array, i = 0; i < o; i++)
        for (var a = r[3 * i + 0], u = r[3 * i + 1], s = r[3 * i + 2], h = 0; h < a; h++) n.push(new P(u, s));
      return n
    ...
    function(t) {
      (t = function t() {
        var r, o, n, h, l, f, g = arguments[0],
          c = 1,
          d = arguments.length,
          m = !1;
        for ("boolean" == typeof g && (m = g, g = arguments[1] || {}, c = 2), (null == g || "object" !== e(g) && "function" != typeof g) && (g = {}); c < d; ++c)
          if (null != (r = arguments[c]))
            for (o in r) n = s(g, o), g !== (h = s(r, o)) && (m && h && (a(h) || (l = i(h))) ? (l ? (l = !1, f = n && i(n) ? n : []) : f = n && a(n) ? n : {}, u(g, {
              name: o,
              newValue: t(m, f, h)
            })) : void 0 !== h && u(g, {
              name: o,
