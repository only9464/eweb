Object.defineProperty(exports, "__esModule", {
  value: !0
}), exports.bankCardAttribution = function(e) {
  var a = {
    DC: "储蓄卡",
    CC: "信用卡",
    SCC: "准贷记卡",
  ...
  function r(e, a) {
    var r, d = {};
    for (r in a = a || {}, e = e || {}) e.hasOwnProperty(r) && (d[r] = e[r]);
    for (r in a) a.hasOwnProperty(r) && (d[r] = a[r]);
    return d
  }
  ...
  return function(e) {
    for (var a = 0, g = C.length; a < g; a++)
      for (var p = C[a], n = p.patterns, T = 0, c = n.length; T < c; T++) {
        var y = n[T];
        if (new RegExp(y.reg).test(e)) {
          var $ = r(p, y);
          return delete $.patterns, delete $.reg, $.cardTypeName = d($.cardType), $
        }
      }
    return "error"
  }(e)
